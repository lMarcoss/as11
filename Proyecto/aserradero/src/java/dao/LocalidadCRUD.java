...
public class LocalidadCRUD extends Conexion implements OperacionesCRUD{
    ...
    public <T> List listar() throws Exception{
        ...
        try{
            this.abrirConexion();
            try (PreparedStatement st = this.conexion.prepareStatement("SELECT * FROM LOCALIDAD")) {
    ...
    public Object modificar(Object objeto) throws Exception{
        ...
        this.abrirConexion();
            try (PreparedStatement st = this.conexion.prepareStatement("SELECT * FROM LOCALIDAD WHERE nombre_localidad = ?")) {
    ...
    public void actualizar(Object objeto) throws Exception{
        ...
        try{
            ...
            st.setString(2,localidad.getTelefono());
    ...
    public <T> List buscar(String nombre_campo, String dato) throws Exception{
        ...
        try{
            this.abrirConexion();
            try (PreparedStatement st = this.conexion.prepareStatement("SELECT * FROM LOCALIDAD WHERE "+nombre_campo+" like ?")) {
                st.setString(1, "%"+dato+"%");
                localidades = new ArrayList();
                try (ResultSet rs = st.executeQuery()) {
                    while (rs.next()) {
    ...
    public Object extraerObject(ResultSet rs) throws SQLException {
        ...
        localidad.setTelefono(rs.getString("telefono"));
        return localidad;
    }
    ...
    public PreparedStatement cargarObject(PreparedStatement st, Object objecto) throws SQLException {
        ...
        st.setString(3,localidad.getTelefono());    
        return st;
    }
