                ...
                <fieldset id="user-details">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 10px;"><input type="number" name="num_piezas" id="num_piezas" value="<%=entrada.getNum_piezas()%>" min="1" max="999" required="" title="Escribe la cantidad de piezas"/></td>
                        </tr>
                        <tr>
                            <td style="padding-left: 10px;"><label>Empleado</label></td>
                            <td style="padding-left: 10px;">
                                <select name="id_empleado" required="" id="id_empleado">
                                    <option value="<%=entrada.getId_empleado()%>"><%=entrada.getEmpleado()%></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
