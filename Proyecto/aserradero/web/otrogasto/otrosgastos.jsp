    ...
    <body>
        ...
        <div>
            <table class="table-condensed">
                    ...
                    <%
                        List <OtroGasto> otrosgastos = (List<OtroGasto>) request.getAttribute("otrosgastos");
                        int i=0;
                        for (OtroGasto otrogasto : otrosgastos) {
                            out.print("<tr>"
                                ...
                                +"<td><a href=\"/aserradero/OtroGastoController?action=modificar&id_gasto="+otrogasto.getId_gasto()+"\">Actualizar</a></td>"
