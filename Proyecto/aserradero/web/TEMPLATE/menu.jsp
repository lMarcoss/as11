        ...
        <ul class="">
            <li class="submenu">
                ...
                <ul class="children">
                    ...
                    <li id="vehiculos"><a href="/aserradero/VehiculoController?action=listar">Veh�culos</a></li>
                </ul>
            </li>
            ...
            <li class="submenu" id="compras">
                ...
                <ul class="children">
                    ...
                    <li class="costo_madera_entrada"><a href="/aserradero/ClasificacionMaderaEntradaController?action=listar">Clasficaci�n</a></li>
                </ul>
            </li>
            <li class="submenu" id="produccion">
                ...
                <ul class="children">
                    ...
                    <li id="clasificacion_madera"><a href="/aserradero/MaderaClasificacionController?action=listar">Clasificaci�n</a></li>
            ...
            <li class="submenu" id="reportes">
                ...
                <ul class="children">
                    ...
                    <li class="reporte_compra"><a href="/aserradero/PagoInteresController?action=listar">Pago inter�s</a></li>
                </ul>
            </li>
            <li class="submenu" id="reportes">
                <a href="#">Reportes</a>
