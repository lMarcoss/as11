                ...
                <%
                    ...
                    for (VentaPaquete detalle : detalles) {
                        out.print("<tr>"
                            ...
                            +"<td><a href=\"/aserradero/VentaPaqueteController?action=modificar&id_venta="+detalle.getId_venta()+"&numero_paquete="+detalle.getNumero_paquete()+"&id_madera="+detalle.getId_madera()+"\">Actualizar</a></td>"
                            +"<td><a href=\"javascript:if (confirm('¿Estás seguro de eliminar?')){parent.location='/aserradero/VentaPaqueteController?action=eliminar&id_venta="+detalle.getId_venta()+"&numero_paquete="+detalle.getNumero_paquete()+"&id_madera="+detalle.getId_madera()+"';};\">Eliminar</a></td>"
                        + "</tr>" );
                        i++;
                    }
                %>
