                ...
                <fieldset id="user-details">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 10px;"><input type="number" name="num_pieza_primario" value="<%=entrada.getNum_pieza_primario()%>" required=""/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 10px;"><input type="number" name="num_pieza_secundario" value="<%=entrada.getNum_pieza_secundario()%>" required=""/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 10px;"><input type="number" name="num_pieza_terciario" value="<%=entrada.getNum_pieza_terciario()%>" required=""/></td>
                        </tr>
                        <tr>
