...
--     ROUND((E.num_piezas * C.volumen),3) AS volumen_total,
--     C.costo_por_volumen,
--     ROUND((E.num_piezas * C.volumen * C.costo_por_volumen),2) AS costo_total,
--     E.id_administrador
-- FROM ENTRADA_MADERA_ASERRADA AS E,MADERA_ASERRADA_CLASIF AS C
-- WHERE E.id_madera = C.id_madera AND E.id_administrador = C.id_administrador;

-- SELECT id_madera, num_piezas, volumen_unitario, volumen_total, costo_por_volumen FROM INVENTARIO_M_ASERRADA;
-- SELECT
-- 	id_madera,
--     num_piezas,
--     id_administrador
