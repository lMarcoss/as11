...
BEGIN
    ...
    IF EXISTS (SELECT num_pieza_primario FROM VISTA_SALIDA_M_ROLLO WHERE id_jefe = _id_jefe) THEN 
...
BEGIN
	...
	-- consultamos si han salido madera rollo
    IF EXISTS (SELECT num_pieza_secundario FROM VISTA_SALIDA_M_ROLLO WHERE id_jefe = _id_jefe) THEN 
...
BEGIN
	...
	-- consultamos si han salido madera rollo
    IF EXISTS (SELECT num_pieza_terciario FROM VISTA_SALIDA_M_ROLLO WHERE id_jefe = _id_jefe) THEN 
...
BEGIN
	...
	-- consultamos si han salido madera rollo
    IF EXISTS (SELECT volumen_primario FROM VISTA_SALIDA_M_ROLLO WHERE id_jefe = _id_jefe) THEN 
...
BEGIN
	...
	-- consultamos si han salido madera rollo
    IF EXISTS (SELECT volumen_secundario FROM VISTA_SALIDA_M_ROLLO WHERE id_jefe = _id_jefe) THEN 
...
BEGIN
	...
	-- consultamos si han salido madera rollo
    IF EXISTS (SELECT volumen_terciario FROM VISTA_SALIDA_M_ROLLO WHERE id_jefe = _id_jefe) THEN 
...
SELECT 
	...
	num_pieza_primario,
    volumen_primario,
    ROUND((SELECT AVG(costo_primario) FROM ENTRADA_M_ROLLO WHERE id_jefe = TESMR.id_jefe),2) AS costo_primario,
    num_pieza_secundario,
    volumen_secundario,
    ROUND((SELECT AVG(costo_secundario) FROM ENTRADA_M_ROLLO WHERE id_jefe = TESMR.id_jefe),2) AS costo_secundario,
    num_pieza_terciario,
    volumen_terciario,
    ROUND((SELECT AVG(costo_terciario) FROM ENTRADA_M_ROLLO WHERE id_jefe = TESMR.id_jefe),2) AS costo_terciario,
    (num_pieza_primario + num_pieza_secundario + num_pieza_terciario) AS num_pieza_total,
